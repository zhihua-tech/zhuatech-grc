...
@Entity @Table(name="grc_control_domain") public class ControlDomain extends BaseEntity {
    ...
    protected ControlDomain(){} public ControlDomain(String code,String name,String workshop,int plannedCapacity){this.code=code;this.name=name;this.workshop=workshop;this.plannedCapacity=plannedCapacity;}
